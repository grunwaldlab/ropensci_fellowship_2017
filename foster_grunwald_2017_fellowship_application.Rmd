...
For example, when filtering taxa, the corresponding user-supplied data can be optionally discarded or reassigned to supertaxa that passed the filter.
...
travel[6,1] <- "Monthly graduate student salary"
travel[6,2] <- 2000
