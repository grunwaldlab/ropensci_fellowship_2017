...
* Port slowest parts of the code to C++ to improve speed using `Rcpp` [@eddelbuettel2011rcpp]
* Add ability to use multiple cores to improve speed using `RcppParallel`
* Add exhaustive unit tests (test coverage of > 95%) using `testthat` [@wickham2011testthat] and codecov
